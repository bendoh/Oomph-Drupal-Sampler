 ...
 *
 */
$drupal_hash_salt = 'fSi-JBrnqLBw9BuEK7QsV04KIoKqdHJXD9FrZtM9QLs';
...
// Allow local config with non-version-controlled settings.local.php files
$local_config = __DIR__ . '/settings.local.php';
